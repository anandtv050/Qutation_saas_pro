...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-[42%] bg-[#18181b] relative overflow-hidden">
        <div className="flex flex-col justify-between w-full px-12 py-16 relative z-10">
          {/* Logo & Brand Name */}
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 bg-white rounded-lg">
              <span className="text-[#18181b] text-xl font-bold">Q</span>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-white font-medium">AI-Powered Generation</h3>
                <p className="text-gray-400 text-sm">Smart quotations from simple descriptions</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Work with your team seamlessly</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 mt-1">
              ...
              <div>
                <h3 className="text-white font-medium">Professional Templates</h3>
                <p className="text-gray-400 text-sm">Beautiful, customizable designs</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-[#fafafa] px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-[#18181b] text-3xl font-bold mb-2">Sign in</h2>
            <p className="text-[#71717a] text-sm">Access your dashboard</p>
          </div>

          {/* Error Message */}
          {error && (
            <div className="mb-6 p-3 bg-[#fef2f2] border border-[#fecaca] rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                autoFocus
                className="w-full h-12 px-4 text-[15px] bg-white rounded-lg border border-[#e4e4e7]
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-12 px-4 pr-12 text-[15px] bg-white rounded-lg border border-[#e4e4e7]
                    text-[#18181b] placeholder:text-[#a1a1aa]
                    focus:outline-none focus:ring-2 focus:ring-[#18181b] focus:border-transparent
                    hover:border-[#a1a1aa]
                    disabled:bg-[#f4f4f5] disabled:cursor-not-allowed
                ...
                <button
                  ...
                  tabIndex={-1}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-[#a1a1aa]
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 text-[15px] font-semibold bg-[#18181b] text-white rounded-lg
