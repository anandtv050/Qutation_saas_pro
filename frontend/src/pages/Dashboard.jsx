  ...
  return (
    <div className="min-h-screen flex items-start justify-center">
      <div className="w-full max-w-md px-5 py-8 md:py-10">
        ...
        {/* Money Stats - clickable only if reports access */}
        {canReports ? (
          ...
          <div className="mb-6 rounded-2xl bg-white border border-neutral-200 p-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
        ...
        {/* Quick Create — needs both quotation and AI access */}
        {canQuotation && canAI && (
        ...
        {/* Add Items — needs quotation access */}
        {canQuotation && (
